...
function handle(req, res) 
{
    let context = {
        ...
        limit: req.query && req.query.pageSize || 0
    };
...
function getOperations(context) 
{
    ...
    return Models.OperationTransactions.getByCompanyAndStatus(Number(context.idCompany), Models.OperationTransactionStatuses.PENDING, options).then(transactions => {
        if (!transactions) {
