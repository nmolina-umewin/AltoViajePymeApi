...
module.exports = {
    ...
    NotExists : {
        ...
        OperationTransaction  : new NotFound('The given operation transaction doesn\'t exist.'),
        OperationTransactions : new NotFound('The given operation transactions doesn\'t exist.'),
