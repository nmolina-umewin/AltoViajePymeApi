...
module.exports = {
    ...
    NotExists : {
        ...
        RechargePaymentOrder          : new NotFound('The given recharge payment order doesn\'t exist.'),
        RechargePaymentOrders         : new NotFound('The given recharge payment orders doesn\'t exist.'),
        RechargePaymentOrderStatus    : new NotFound('The given recharge payment order status doesn\'t exist.'),
        RechargePaymentOrderStatuses  : new NotFound('The given recharge payment order statuses doesn\'t exist.'),
