...
module.exports = {
    ...
    allAvailablePoints : function() {
        return 'SELECT SUM(w.points) AS total FROM companies AS c JOIN company_wallets AS w ON w.id_company = c.id WHERE c.deleted_at IS NULL';
    }
};
